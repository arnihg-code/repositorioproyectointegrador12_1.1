                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-md-5 ">
                            <div class="btn-group pull-right">
                                <a href="srvUsuario?accion=listarValeSalida" class="btn btn-default">
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nuevo Vale de Salida</h3>  
                        </div>
                        <form class="form-horizontal" action="srvUsuario?accion=registrarvalesalida" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Codigo del Vale de Salida </label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ingrese el codigo" name="txtidValeSalida" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <select class="form-control"  name="cboConcepto" autofocus=""  required="">
                                            ...
                                            <c:forEach items="${conceptos}" var="con">
                                                <option value="${con.idConcepto}"  
                                                        <c:if test="${con.idConcepto == 
                                                                      ValeSalida.Concepto.idConcepto}">
                                                              selected
                                                        </c:if>
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="form-control"  name="cboProveedor" autofocus=""  required="">
                                            ...
                                            <c:forEach items="${proveedores}" var="prov">
                                                <option value="${prov.idProveedores}"  
                                                        <c:if test="${prov.idProveedores == 
                                                                      ValeSalida.nombresProveedor.idProveedores}">
                                                              selected
                                                        </c:if>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-tags"></i></span>
                                        <select class="form-control"  name="cboProducto" autofocus=""  required="">
                                            <option value="0">Seleccione un producto</option>
                                            <!--el cargos de aqui abajo solo es un nombre que se relaciona con el
                                             car de la parte del servlet-->
                                            <c:forEach items="${productos}" var="product">
                                                <option value="${product.idProducto}"  
                                                        <c:if test="${product.idProducto == 
                                                                      ValeSalida.nomProducto.idProducto}">
                                                              selected
                                                        </c:if>
                                                        >${product.desProducto}</option>
                                            </c:forEach>
                                        </select>
                                    </div>                                  
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="text" class="form-control" placeholder="Ingrese las observaciones" name="txtobservacion" maxlength="10"
                                               value="">
                                    </div>
                                </div>
